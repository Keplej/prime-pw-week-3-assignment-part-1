...
let favoriteFoodsArray = ['Rice', 'Beef Stew', 'Pizza']
...
console.log('Last animal is a', animalArray[animalArray.length - 1]);
...
favoriteFoodsArray.push('Pasta');
console.log('Added food to the end,', favoriteFoodsArray);
...
let removedFoods = favoriteFoodsArray.pop();
...
favoriteFoodsArray.unshift('Kimchi');
...
//     log both the food removed and the updated array
removedFoods = favoriteFoodsArray.shift();
